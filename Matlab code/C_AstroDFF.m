...
H = MTXTrialType(:,3) >= 5 & MTXResp(:,3) > 0 & MTXTrialType(:,5)<1;
M = MTXTrialType(:,3) >= 5 & MTXResp(:,3) < 1 & MTXTrialType(:,5)<1;
CR = MTXTrialType(:,3) < 5 & MTXResp(:,3) < 1 & MTXTrialType(:,5)<1;
FA = MTXTrialType(:,3) < 5 & MTXResp(:,3) > 0 & MTXTrialType(:,5)<1;

...
for i = 1:length(idx)
   ...
   elseif trialType(i) == 4 & trialType(i + 1) ==2 & idxOpto(i)==0
           trialTypepostFA(i+1) =2; 
   elseif trialType(i)== 4 & trialType(i + 1) == 3 & idxOpto(i)==0
               trialTypepostFA(i+1) = 3; 
   elseif  trialType(i)== 4 & trialType(i + 1) == 4 & idxOpto(i)==0
                   trialTypepostFA(i+1)=4;
   elseif trialType(i) == 4 & trialType(i + 1) == 1 & idxOpto(i)==1
                    trialTypepostFA(i+1) = 5;
   elseif trialType(i) == 4 & trialType(i + 1) ==2 & idxOpto(i)==1
                        trialTypepostFA(i+1) =6; 
   elseif trialType(i)== 4 & trialType(i + 1) == 3 & idxOpto(i)==1
                            trialTypepostFA(i+1) = 7; 
   elseif trialType(i)== 4 & trialType(i + 1) == 4 & idxOpto(i)==1
